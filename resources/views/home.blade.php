...
<body class="font-sans antialiased">
    ...
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
        ...
        <section class="background-radial-gradient pt-16 pb-12 text-center lg:text-left">
            <div
                class="relative overflow-hidden bg-cover bg-no-repeat bg-[50%] bg-[url('https://loremflickr.com/2500/1600/electrician?=random')] h-[500px]">
                <div
                ...
                <div class="flex justify-center">
                    <div class="max-w-[700px] text-center">
                        ...
                        <p class="mb-16 text-gray-500 dark:text-gray-400">
                            ...
                            of challenges and possibilities with resilience. Just as a masterful conductor harmonizes an
                            ...
                            traditional boundaries and engineer new horizons. With meticulous attention to detail and a
                ...
                <div class="flex flex-wrap">
                    <div class="mb-12 w-full shrink-0 grow-0 basis-auto lg:mb-0 lg:w-5/12">
                        <div class="flex lg:py-12 ">
                            <img src="https://loremflickr.com/2500/1600/electric,electrician/all?random=4"
                            ...
                            <div data-aos="fade-down" class="lg:pl-12">
                                <div class="border-b border-gray-200 dark:border-gray-700">
                                    ...
                                    <p class="mb-8 pb-2 lg:pb-0 text-gray-500 dark:text-gray-400">
                                        Explore our comprehensive range of electrical engineering services, designed to
                                        meet the diverse needs of the public sector. From innovative infrastructure
                                        solutions to cutting-edge energy optimization, we deliver excellence in every
                                        project.
                                    </p>
                                ...
                                <div class="mt-8" data-aos="fade-down">
                                    ...
                                    <p class="mb-8 pb-2 lg:pb-0 text-gray-500 dark:text-gray-400">
                                        ...
                                        equipping professionals with the skills needed to thrive in dynamic governmental
                                        environments.
                                    </p>
                ...
                <div data-aos="flip-up"
                    ...
                    <div class="flex flex-wrap items-center">
                        <div class="block w-full shrink-0 grow-0 basis-auto lg:flex lg:w-6/12 xl:w-4/12">
                            <img src="https://loremflickr.com/2500/1600/electric,electrician/all?random=5"
